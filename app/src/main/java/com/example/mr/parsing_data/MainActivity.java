package com.example.mr.parsing_data;
...
public class MainActivity extends ListActivity {
    ...
    private static String url = "http://dthan.net/json_mhs.php?nim=1137050164";
    // JSON Node names
    ...
    private static final String TAG_ALAMAT = "jln";
    @Override
 ...
 * */
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    TAG_ANGKATAN,TAG_ALAMAT}, new int[]{R.id.nama,
                    R.id.nim, R.id.angkatan,R.id.alamat});
    ...
    private ArrayList<HashMap<String, String>> ParseJSON(String json) {
        if (json != null) {
            try {
// Hashmap for ListView
                ArrayList<HashMap<String, String>> studentList = new
...
// looping through All Students
                for (int i = 0; i < students.length(); i++) {
                    ...
                    String jln = "jalan : " + c.getString(TAG_ALAMAT);

// tmp hashmap for single student
                    HashMap<String, String> student = new HashMap<String,
                            String>();
// adding each child node to HashMap key => value
                    student.put(TAG_NAMA, nama);
                    student.put(TAG_NIM, nim);
                    student.put(TAG_ANGKATAN, angkatan);
                    student.put(TAG_ALAMAT, jln);
